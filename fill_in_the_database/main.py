...
if __name__ == "__main__":
    ...
    updated_product_df = update_product_stock("data_completed/FINAL_PRODUCT_MOCK_DATA.csv")

    # --- Merge orders_details incrementally ---
    merge_csvs_with_incremental_id("data/order_details/ORDER_DETAILS_MOCK_DATA_", 190,
                                   "id_detail","data/ORDER_DETAILS_MOCK_DATA_MERGED.csv")
    ...
    merge_csvs_with_incremental_id("data/orders/COSTUMER_ORDER_", 50,
                                   "id_order","data/ORDERS_MOCK_DATA_MERGED.csv")
    ...
    validate_and_fix_orders("data_completed/FINAL_ORDER_DETAILS_MOCK_DATA.csv",
        "data_completed/FINAL_CLIENT_MOCK_DATA.csv", "data/ORDERS_MOCK_DATA_MERGED.csv",
    ...
    reorder_csv_columns(
        input_path="data_completed/FINAL_ORDER_MOCK_DATA.csv",
        ordered_columns=["id_order", "id_client", "order_date", "total", "state"]
    )
